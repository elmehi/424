...
\begin{document}
	...
	Logistic regression is a linear classification method that uses the loss function
	\begin{align}
	...
	\begin{tabular}[]{@{}|c|c|c|c|c|c|c|c|@{}}
		...
		\hline
	\end{tabular}
	\caption{{\bf Results from 3 classifiers on sentiment analysis data.} We list values for however many classifiers, each with and without using feature selection. We also divide results into those useful when looking for positive and negative sentiment.}
	\label{tab:results}
	\end{table}
