...
\begin{document}
	...
	Feature extraction was performed during the training portion of the project. We extracted features from a dictionary of stemmed k-grams that included both single words and bigrams. 
